...
?>
<!-- <?php echo $theme->themename ?> v.<?php echo $theme->themeversion ?> (<?php echo $theme->colorpack ?> : <?php echo $theme->framepack ?>) - Copyright (c) 2009-2012 Serguei Dosyukov - All Rights Reserved -->
<head>
...
<?php echo $theme->breadcrumb_menu($theme, null); ?>
<?php else: ?>
    <?php echo $theme->breadcrumb_menu($theme, $parents); ?>
  <?php endif; ?>
  ...
  <?php switch ($theme->sidebarvisible):
     ...
     case "top":
       ...
       default:
         ...
         break;
   endswitch; ?>
<?php if (($theme->page_subtype != "login") and ($theme->page_subtype != "reauthenticate")): ?>
<?php  if (($theme->sidebarvisible == "none") or ($theme->sidebarvisible == "bottom") or ($theme->sidebarvisible == "top")): ?>
